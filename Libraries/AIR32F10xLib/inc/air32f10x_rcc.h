...
/** @defgroup APB2_peripheral 
  * @{
  */
/* RCC_APB2Periph_AFIO：用于配置AFIO外设时钟使能。
RCC_APB2Periph_GPIOA-GPIOG：用于配置GPIOA-GPIOG外设时钟使能，其中GPIOA为GPIO Port A，GPIOB为GPIO Port B，以此类推。
RCC_APB2Periph_ADC1-ADC3：用于配置ADC1-ADC3外设时钟使能。
RCC_APB2Periph_TIM1/TIM8：用于配置高级定时器TIM1/TIM8外设时钟使能。
RCC_APB2Periph_TIM9-TIM11：用于配置通用定时器TIM9-TIM11外设时钟使能。
RCC_APB2Periph_SPI1：用于配置SPI1外设时钟使能。
RCC_APB2Periph_USART1：用于配置USART1外设时钟使能。 */
